  ...
  const createSupportTicket = async (rmaNumber: string) => {
    try {
      const ticketData = {
        ...
        alternativeShipping: formData.alternativeShipping,
        alternativeAddress: formData.alternativeAddress,
        alternativeCity: formData.alternativeCity,
        alternativeZip: formData.alternativeZip,
